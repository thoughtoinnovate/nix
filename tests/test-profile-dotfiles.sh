...
grep -Fq '.local/bin' "$TEST_HOME/.config/shell/common.sh"
...
grep -Fq 'home_weave_local_bin' "$TEST_HOME/.config/fish/config.fish"
[[ -L "$TEST_HOME/.zshrc" ]]
...
grep -Fq 'home_weave_local_bin' "$TEST_HOME/.config/nushell/env.nu"
